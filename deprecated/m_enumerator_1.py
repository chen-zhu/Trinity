...
from tyrell.enumerator import SmtEnumerator, RandomEnumerator, DesignatedEnumerator
...
def main():
    ...
    #         equal_output=eq_r
    #     )
    # print(decider.has_failed_examples(prog))
    # input("PAUSE")
    ...
    synthesizer = Synthesizer(
        ...
        enumerator=RandomEnumerator(spec, max_depth=4),
